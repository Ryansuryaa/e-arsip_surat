                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="letter_type" class="form-control" required onchange="this.options[this.selectedIndex].value=='Surat Keluar' ? toggleField('inputSender','selectSender') : toggleField('selectSender','inputSender')">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        {{-- <input type="text" list="sender" class="form-control" name="sender" placeholder="Pengirim">
                                        <datalist id="sender">
                                            @foreach ($senders as $sender)
                                                <option value="{{ $sender->id }}" {{ (old('sender') == $sender->id)? 'selected':''; }}>{{ $sender->name }}</option>
                                            @endforeach
                                        </datalist> --}}
                                        <select class="form-select" id="selectSender" name="sender" style="display:none;" disabled="disabled">
                                            <option value="">Pilih..</option>
                                            @foreach ($senders as $sender)
                                            <option value="{{ $sender->id }}" {{ (old('sender') == $sender->id)? 'selected':''; }}>{{ $sender->name }}</option>
                                            @endforeach
                                        </select>
                                        <input name="sender" id="inputSender" class="form-control">
                                    </div>
                                    @error('sender_id')
                                        <div class="invalid-feedback">
                                            {{ $message; }}
...
@push('addon-script')
    ...
    <script>
        function toggleField(val1, val2){
            let hideObj = document.getElementById(val1);
            let showObj = document.getElementById(val2);
